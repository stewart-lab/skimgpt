...
# Try to install skimgpt 0.1.6 from TestPyPI
RUN pip install --no-cache-dir --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ skimgpt==0.1.6
